    ...
    <BaseEmailTemplate preview={preview}>
      ...
      <Card title={`🎫 Tickets Won (${tickets.length})`}>
        {tickets.length > 0 ? (
          ...
          <Text style={emptyText}>No tickets in this bundle</Text>
        )}
      </Card>

      <Card title={`🏆 Memorabilia Won (${memorabilia.length})`}>
        {memorabilia.length > 0 ? (
          ...
          <Text style={emptyText}>No memorabilia in this bundle</Text>
        )}
      </Card>
      ...
      <Section style={nextSteps}>
        ...
        <Text style={listItem}>
          <strong>2. Memorabilia Shipping:</strong> Physical items will be shipped to your address within 5-7 business days
        </Text>
        <Text style={listItem}>
      ...
      <Section style={{ marginTop: '32px' }}>
        ...
        <Text style={supportText}>
          Reply to this email or contact us at support@seatjumper.com
        </Text>
        <Text style={supportText}>
