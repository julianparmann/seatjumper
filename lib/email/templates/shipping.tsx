...
export const ShippingEmail: React.FC<ShippingEmailProps> = ({
  ...
  const preview = `Your SeatJumper memorabilia has shipped!`;
  ...
  return (
    <BaseEmailTemplate preview={preview}>
      ...
      <Text style={paragraph}>
        Great news! Your SeatJumper memorabilia has been shipped and is on its way to you.
      </Text>
      ...
      <Section style={whatToExpect}>
        ...
        <Text style={expectItem}>
          • Collectibles are carefully wrapped for protection
        </Text>
        <Text style={expectItem}>
          • Trading cards are shipped in protective sleeves/cases
        </Text>
        <Text style={expectItem}>
